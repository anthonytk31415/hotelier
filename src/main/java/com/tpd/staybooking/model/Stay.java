...
public class Stay {
    ...
    @ManyToOne // a host can have many stays.
    ...
    @OneToMany(mappedBy = "stay", cascade = CascadeType.ALL, fetch = FetchType.EAGER) // It can be omitted because the
                                                                                      // reference relationship in the
                                                                                      // database is already set up in
                                                                                      // StayImage. However, writing it
                                                                                      // out can be more convenient, as
                                                                                      // it allows us to directly
                                                                                      // retrieve the information all at
                                                                                      // once.
